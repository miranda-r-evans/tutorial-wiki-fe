describe('/tutorial/edit', () => {
  ...
  it('should accept input text, create a new section, and embed a section', () => {
    ...
    cy.get('input[class=heading-input]').type('{end}+1')
    cy.get('input[class=heading-input]').should('have.value', 'main heading+1')
  ...
  it('should be able to nest sections and display a text editing area above and below the section', () => {
    ...
    cy.realPress('Enter')
    cy.get('div[class=tutorial]:first p:first').should('have.text', 'main paragraph')
  ...
  it('should insert the new section after the line that the cursor is on', () => {
    ...
    cy.get('div[class=mce-content-body]:first p:first').should('have.text', 'main paragraph')
  ...
  it('should be able to display saved nested sections from the url id', () => {
    ...
    cy.get('div[class=tutorial]:first p:first').should('have.text', 'embedded paragraph 3')
    cy.get('div[class=tutorial]:first').find('div[class=tutorial] p').should('have.text', 'embedded paragraph 4')
  })
})
